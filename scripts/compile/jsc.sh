...
mkdir -p $INSTALL_CPPRUNTIME_UNSTRIPPED_DIR/$JNI_ARCH
...
cp $TOOLCHAIN_DIR/sysroot/usr/lib/$CROSS_COMPILE_PLATFORM/libc++_shared.so $INSTALL_CPPRUNTIME_UNSTRIPPED_DIR/$JNI_ARCH
cp $TOOLCHAIN_DIR/sysroot/usr/lib/$CROSS_COMPILE_PLATFORM/libc++_shared.so $INSTALL_CPPRUNTIME_DIR/$JNI_ARCH
$TOOLCHAIN_DIR/$CROSS_COMPILE_PLATFORM/bin/strip $INSTALL_CPPRUNTIME_DIR/$JNI_ARCH/libc++_shared.so
